...
class FeatureFlagsSettingViewModel: ObservableObject {
    ...
    @Published var cssExperiments: [CSSExperimentsFeatureFlags] = []
    ...
    init() {
        ...
        self.cssExperiments = CSSExperimentsFeatureFlags.allCases.filter { $0.supportsLocalOverriding && $0.cohortType != nil }
    }
