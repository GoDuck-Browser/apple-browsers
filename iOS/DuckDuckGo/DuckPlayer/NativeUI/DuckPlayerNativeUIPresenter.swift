...
final class DuckPlayerNativeUIPresenter {
    ...
    struct Constants {
        ...
        static let primingModalHeight: CGFloat = 450
        ...
        static let primingModalPresentedCountThreshold: Int = 100
        static let primingModalTimeSinceLastPresentedThreshold: Int = 10  // 24h
    }
