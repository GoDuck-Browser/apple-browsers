...
final class VPNFeedbackFormViewController: NSViewController {
    ...
    init() {
        self.viewModel = VPNFeedbackFormViewModel(metadataCollector: DefaultVPNMetadataCollector(subscriptionManager: Application.appDelegate.subscriptionAuthV1toV2Bridge))
