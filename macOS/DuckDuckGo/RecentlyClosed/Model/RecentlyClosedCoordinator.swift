...
extension Tab.TabContent {
    ...
    func loadedFromCache() -> Self {
        ...
        case .newtab, .settings, .bookmarks, .history, .onboardingDeprecated, .onboarding, .releaseNotes, .none, .dataBrokerProtection, .subscription, .identityTheftRestoration, .webExtensionUrl, .webExtensionStore:
            self
        }
    }
