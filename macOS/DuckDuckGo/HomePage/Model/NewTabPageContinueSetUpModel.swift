//
//  NewTabPageNextStepsModel.swift
//
...
protocol NewTabPageNextStepsModelTabOpening {
    @MainActor
    func openTab(_ tab: Tab)
}

struct TabCollectionViewModelTabOpener: NewTabPageNextStepsModelTabOpening {
...
final class NewTabPageNextStepsModel: ObservableObject {
    ...
    private let tabOpener: NewTabPageNextStepsModelTabOpening
    ...
    init(defaultBrowserProvider: DefaultBrowserProvider = SystemDefaultBrowserProvider(),
         ...
         tabOpener: NewTabPageNextStepsModelTabOpening,
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(newTabOpenNotification(_:)), name: TabCollectionViewModel.newTabPageDidOpen, object: nil)
    ...
    enum FeaturesGridDimensions {
        ...
        static let width: CGFloat = (itemWidth + horizontalSpacing) * CGFloat(NewTabPageNextStepsModel.Const.featuresPerRow) - horizontalSpacing
