...
final class DBPEndToEndTests: XCTestCase {
    ...
    func testWhenProfileIsSaved_ThenEachStepHappensInSequence() async throws {
        ...
        */
        ...
        let optOutEmailReceivedPixel = DataBrokerProtectionMacOSPixels.optOutEmailReceive(dataBroker: "", attemptId: UUID(), duration: 0)
        let optOutEmailConfirmedPixel = DataBrokerProtectionMacOSPixels.optOutEmailConfirm(dataBroker: "", attemptId: UUID(), duration: 0)
...
private extension DBPEndToEndTests {
    ...
    typealias PixelExpectation = (pixel: DataBrokerProtectionMacOSPixels, expectation: XCTestExpectation)
