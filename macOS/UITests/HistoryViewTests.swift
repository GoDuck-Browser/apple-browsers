...
class HistoryViewTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        app.enableFeatureFlagIfNeeded("historyView")
        app.menuItems["MainMenu.history"].doubleClick()
    }

    func testHistoryViewShortcut() {
        app.typeKey("y", modifierFlags: [.command])
        XCTAssertTrue(app.staticTexts["History"].waitForExistence(timeout: UITests.Timeouts.elementExistence), "History Page should be shown")
    }
