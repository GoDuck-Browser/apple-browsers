...
extension FeatureFlag: FeatureFlagDescribing {
    ...
    public var supportsLocalOverriding: Bool {
        switch self {
        case .htmlNewTabPage, .autofillPartialFormSaves, .autcompleteTabs, .networkProtectionAppExclusions, .networkProtectionAppStoreSysex, .networkProtectionRiskyDomainsProtection, .syncSeamlessAccountSwitching, .historyView, .webExtensions, .autoUpdateInDEBUG, .popoverVsBannerExperiment, .scamSiteProtection:
            return true
        case .debugMenu,
