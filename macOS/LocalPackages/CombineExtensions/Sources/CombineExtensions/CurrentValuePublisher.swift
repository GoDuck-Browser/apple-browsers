...
/// Similar to CurrentValueSubject but keeps the value private.
///
/// Useful for publishing values while ensuring there's always a current value available for synchronous access.
///
