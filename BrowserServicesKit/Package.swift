...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/duckduckgo/duckduckgo-autofill.git", branch: "shane/build-assets"),
        ...
        .package(url: "https://github.com/duckduckgo/content-scope-scripts", exact: "7.28.0"),
        .package(url: "https://github.com/duckduckgo/privacy-dashboard", exact: "8.5.0"),
